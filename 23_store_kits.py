...
class TestStoreCart(unittest.TestCase):
    ...
    def test_store_cart_transaction(self): 
        ...
        driver.find_element_by_xpath("//input[@id='id_first_name']").send_keys("Sandy")
        driver.find_element_by_xpath("//input[@id='id_last_name']").send_keys("Thomson")
        driver.find_element_by_xpath("//input[@id='id_company']").send_keys("self")
        driver.find_element_by_xpath("//input[@id='id_address']").send_keys("6573 Northridge Dr.")
        ...
        driver.find_element_by_xpath("//input[@id='id_email']").send_keys("sthomson@netscape.net")
        driver.find_element_by_xpath("//input[@id='id_int_phone']").send_keys("1 408-268-0001")
